...
private:
    ...
    void writeFile(QString filename, QString line, int count);
    void flushFile();
    ...
    void processOneCardFiveNumber(QList<QString> col,QString line);
    void processOneCardMultiName(QList<QString> col,QString line);
    /* 文件输出路径 */
    QString path;
    bool countData();
    ...
    void saveOnecardMultiName(QString line);
    void saveOnecardFiveCode(QString line);
    void readConfig();
