...
ImgProcessor::ImgProcessor(QWidget *parent)
    : QMainWindow(parent)
{
    setWindowTitle(tr("XXX检查工具"));			//设置窗体标题
...
{
    //“打开”动作
    openFileAction =new QAction(QIcon("../../../open.png"),tr("打开"),this);//(a) /users/zhangxianjin/qtcode/build-ImageProcessor-Desktop_Qt_5_8_0_clang_64bit-Debug
...
void ImgProcessor::createMenus()
{
    ...
    //缩放菜单
    zoomMenu =menuBar()->addMenu(tr("配置"));
    ...
    //旋转菜单
    rotateMenu =menuBar()->addMenu(tr("帮助"));
